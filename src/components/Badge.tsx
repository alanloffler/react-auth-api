...
const badgeVariants = cva("inline-flex items-center font-medium uppercase", {
  variants: {
    size: {
    ...
    variant: {
      ...
      ic: "bg-neutral-200 text-neutral-700 text-xs lowercase font-normal",
      id: "bg-neutral-100 text-neutral-600 text-xs lowercase font-normal",
